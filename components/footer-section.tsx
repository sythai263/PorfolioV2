      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-6">
            ...
            <div>
              <h3 className="text-h3 text-card-foreground mb-3">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a
                  href="#home"
                  className="text-b16-reg text-neutral-04 hover:text-primary"
                >
                  Home
                </a>
              </li>
          ...
          <div>
            ...
            <div className="flex space-x-3">
              <a
                href="#"
                className="p-2 bg-neutral-08 rounded-lg hover:bg-primary hover:text-white transition-colors"
              >
