  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Name & Role */}
        <h3 className="text-xl md:text-2xl font-bold text-foreground text-center">{item.name}</h3>
        <p className="text-sm text-muted-foreground mt-1 mb-4 text-center">{item.role}</p>
